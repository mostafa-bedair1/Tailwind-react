    ...
    <section>
        <div className="container relative">
            <div className="bg-[#1c2230] absolute left-[50%] translate-x-[-50%] top-[-150px] rounded-[5px] element-center flex-col w-[865px] min-h-[275px] max-w-full text-white text-center p-[30px]">
                <h3 className="text-[25px] md:text-[35px] font-semibold mb-[15px] ">Get early accese tody</h3>
                <p className="w-[620px] max-w-full mx-auto mb-[30px]">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Magni, voluptas!
                    Natus nihil architecto aspernatur, ipsum vitae aliquid repellat odit maxime ipsam 
                </p>
                <form className="w-full flex justify-between items-center flex-wrap md:px-[60px] gap-[30px] text-sm text-black font-medium">
                    <input 
                    type="email" 
                    placeholder="email@example.com" 
                    className="w-full md:flex-1 h-[50px] rounded-[30px] pl-[30px] outline-none " />
